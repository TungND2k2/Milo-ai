...
describe("Shell Path Escaping", () => {
	...
	describe("Unix/Linux/macOS path escaping", () => {
		...
		it("should handle workspace hooks with spaces in root", () => {
			const path = "/Users/user/My Example Project/.milorules/hooks/PreToolUse"
			const escaped = escapeShellPath(path)
			escaped.should.equal("'/Users/user/My Example Project/.milorules/hooks/PreToolUse'")
		})
	...
	describe("Windows path escaping", () => {
		...
		it("should handle workspace hooks with spaces in root", () => {
			const path = "C:\\Users\\user\\My Example Project\\.milorules\\hooks\\PreToolUse"
			const escaped = escapeShellPath(path)
			escaped.should.equal('"C:\\Users\\user\\My Example Project\\.milorules\\hooks\\PreToolUse"')
		})
	...
	describe("Real-world scenarios", () => {
		...
		it("should handle workspace with company name and spaces", () => {
			setPlatform("darwin")
			const path = "/Users/user/Projects/ACME Corp Project/.milorules/hooks/PreToolUse"
			const escaped = escapeShellPath(path)
			escaped.should.equal("'/Users/user/Projects/ACME Corp Project/.milorules/hooks/PreToolUse'")
		})

		it("should handle workspace with version numbers and spaces", () => {
			setPlatform("darwin")
			const path = "/Users/user/Projects/My Project v2.0/.milorules/hooks/PreToolUse"
			const escaped = escapeShellPath(path)
			escaped.should.equal("'/Users/user/Projects/My Project v2.0/.milorules/hooks/PreToolUse'")
		})

		it("should handle workspace with mixed special characters", () => {
			setPlatform("darwin")
			const path = "/Users/user/Projects/Test's (New) Project v2.0/.milorules/hooks/PreToolUse"
			const escaped = escapeShellPath(path)
			escaped.should.equal("'/Users/user/Projects/Test'\\''s (New) Project v2.0/.milorules/hooks/PreToolUse'")
		})
	})
	...
	describe("Multi-root workspace scenarios", () => {
		it("should handle multiple roots with spaces (macOS)", () => {
			setPlatform("darwin")
			const roots = [
				"/Users/user/My Frontend Project/.milorules/hooks/PreToolUse",
				"/Users/user/My Backend Project/.milorules/hooks/PreToolUse",
				"/Users/user/Shared Utils/.milorules/hooks/PreToolUse",
			]
		...
		it("should handle multiple roots with spaces (Windows)", () => {
			setPlatform("win32")
			const roots = [
				"C:\\Users\\user\\My Frontend Project\\.milorules\\hooks\\PreToolUse",
				"C:\\Users\\user\\My Backend Project\\.milorules\\hooks\\PreToolUse",
				"C:\\Users\\user\\Shared Utils\\.milorules\\hooks\\PreToolUse",
			]
