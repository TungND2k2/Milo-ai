...
The user has explicitly asked you to help them create a new Cline rule file inside the .milorules top-level directory based on the conversation up to this point in time. The user may have provided instructions or additional information for you to consider when creating the new Cline rule.
...
Usage:
<new_rule>
<path>.milorules/{file name}.md</path>
<content>Cline rule file content here</content>
</new_rule>

Example:
<new_rule>
<path>.milorules/project-preferences.md</path>
<content>
## Brief overview
