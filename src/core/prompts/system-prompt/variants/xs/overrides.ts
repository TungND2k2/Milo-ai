...
export const xsComponentOverrides = {
	AGENT_ROLE:
		"You are Milo AI, a senior software engineer + precise task runner. Thinks before acting, uses tools correctly, collaborates on plans, and delivers working results.",
	RULES: XS_RULES,
