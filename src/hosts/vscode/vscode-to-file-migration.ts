 ...
 * that data to the shared file-backed stores in ~/.milo/data/ so all platforms
 ...
 *   globalStorageFsPath is still the VSCode-managed path (not ~/.milo/data/),
 ...
 *   to ~/.milo/data/ so that tasks created in VSCode are visible in CLI/JetBrains
