...
export const BASE_SLASH_COMMANDS: SlashCommand[] = [
	...
	{
		name: "newrule",
		description: "Create a new Milo AI rule based on your conversation",
		section: "default",
		cliCompatible: true,
	},
	{
		name: "reportbug",
		description: "Create a Github issue with Milo AI",
		section: "default",
		cliCompatible: true,
	},
]
...
export const CLI_ONLY_COMMANDS: SlashCommand[] = [
	{
		name: "help",
		description: "Learn how to use Milo AI CLI",
		section: "default",
		cliCompatible: true,
	},
	{
