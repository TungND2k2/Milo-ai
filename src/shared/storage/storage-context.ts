...
export interface StorageContext {
	...
	/** The resolved path to the data directory (~/.milo/data) */
 ...
 *
 * File layout:
 *   ~/.milo/data/globalState.json    — global state
 *   ~/.milo/data/secrets.json        — secrets (mode 0o600)
 *   ~/.milo/data/workspaces/<hash>/workspaceState.json — per-workspace state
 *
