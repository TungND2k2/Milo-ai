...
`
	...
	beforeEach(async () => {
		...
		// Create .milorules/hooks subdirectory structure
		tempDir = path.join(baseTempDir, ".milorules", "hooks")
		await fs.mkdir(tempDir, { recursive: true })
		testHandler = createTestHandler()
		mockMessages = []

		// Mock StateManager to return baseTempDir as workspace root
		// This allows HookFactory to find hooks in baseTempDir/.milorules/hooks/
