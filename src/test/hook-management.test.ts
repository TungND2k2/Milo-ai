...
describe("Hook Management", () => {
	...
	beforeEach(async () => {
		...
		globalHooksDir = path.join(tempDir, "global", "Documents", "Milo AI", "Hooks")
		workspaceHooksDir = path.join(tempDir, "workspace", ".milorules", "hooks")
	...
	describe("Edge Cases", () => {
		it("should handle missing .milorules directory gracefully", async function () {
			this.timeout(5000)
