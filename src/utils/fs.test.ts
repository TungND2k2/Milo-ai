...
describe("Filesystem Utilities", () => {
	...
	it("should exclude .milorules/workflows directory specifically", async () => {
		// Create a test directory structure
		const clinerulesDirTest = path.join(tmpDir, "clinerules-test")
		const clinerulesDirPath = path.join(clinerulesDirTest, ".milorules")

		// Create .milorules directory and root files
		...
		// Create .milorules/other directory and files
		...
		// Create .milorules/workflows directory and files
		...
		const filteredFiles = await readDirectory(clinerulesDirPath, [[".milorules", "workflows"]])
	...
	it("should exclude .milorules/hooks directory specifically", async () => {
		// Create a test directory structure
		...
		// Create .milorules/hooks directory and files
		...
		const filteredFiles = await readDirectory(clinerulesDirPath, [[".milorules", "hooks"]])
