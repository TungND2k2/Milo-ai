...
const ClineLogoBlack = (props: SVGProps<SVGSVGElement>) => (
	<svg fill="none" height="200" viewBox="0 0 200 200" width="200" xmlns="http://www.w3.org/2000/svg" {...props}>
		<path d="M50 150L75 50L100 100L125 50L150 150" stroke="black" strokeWidth="10" strokeLinecap="round" strokeLinejoin="round"/>
		<circle cx="100" cy="100" r="70" stroke="black" strokeWidth="10" strokeOpacity="0.2"/>
