...
const FEATURE_TIPS: FeatureTipItem[] = [
	{
		text: 'Enable "Double-Check Completion" in settings to have Milo verify its work before finishing a task.',
	},
	{
		text: "Add a .clinerules file to your project root to give Milo project-specific instructions.",
	},
	{
		text: "Switch to Plan Mode to discuss and plan an approach before Milo takes action.",
	},
	{
		text: "Use @ in the chat input to add files, folders, or URLs as context for your task.",
	},
	{
		text: "Set up MCP Servers to give Milo access to external tools and APIs.",
	},
	{
		text: "Milo creates checkpoints after changes — you can always restore to a previous state.",
	},
	{
	...
	{
		text: "Use the quote button to select text from Milo's response and reference it in your reply.",
	},
	{
		text: "You can drag and drop images into the chat to share screenshots with Milo.",
	},
	{
		text: "Milo can browse websites — ask it to test your local dev server in the browser.",
	},
	{
 ...
 * Appears after a brief delay and cycles through tips while Milo is thinking.
 */
