...
const UserMessage: React.FC<UserMessageProps> = ({ text, images, files, messageTs, sendMessageFromChatRow }) => {
	...
	return (
		<div
			className="p-2.5 pr-1 my-1 rounded-xs"
			onClick={handleClick}
			style={{
				backgroundColor: isEditing ? "unset" : "var(--vscode-textBlockQuote-background, rgba(255,255,255,0.05))",
				color: "var(--vscode-foreground)",
				borderLeft: isEditing ? "none" : "3px solid var(--vscode-textBlockQuote-border, rgba(255,255,255,0.1))",
				whiteSpace: "pre-line",
				wordWrap: "break-word",
			}}>
			{isEditing ? (
