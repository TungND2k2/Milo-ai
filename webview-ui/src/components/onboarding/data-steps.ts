...
export const USER_TYPE_SELECTIONS: UserTypeSelection[] = [
	...
	{ title: "Bring my own API key", description: "Use Milo AI with your provider of choice", type: NEW_USER_TYPE.BYOK },
]
